...
character_y_pose = screen_height - stage_height - character_height

character_speed = 0 #이동속도
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_LEFT:
                ...
                weapon_x_pose = character_x_pose + character_width // 2 - weapon_width // 2
                weapon_y_pose = character_y_pose
                weapons.append([weapon_x_pose, weapon_y_pose])
        if event.type == pygame.KEYUP:
            character_speed = 0

    character_x_pose += character_speed
    if character_x_pose < 0:
        character_x_pose = 0
    if character_x_pose > screen_width - character_width:
        character_x_pose = screen_width - character_width
    ...
    character_rect.left = character_x_pose
    character_rect.top = character_y_pose
